...
- **Keyboard Support** : Press **Enter** to generate a QR code instantly.  

##  How to Use  
1. **Enter a URL or text** : Type in the input field.  
2. **Click "Generate QR Code"** : A unique QR code will be created.  
3. **Download the QR Code** : Click the download button to save it.  
